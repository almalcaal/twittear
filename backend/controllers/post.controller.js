...
export const getAllPosts = async (req, res) => {
  try {
    // without .populate(), we only have access to the user id with no other fields, like username or name
...
// @desc            Get all people user following posts
...
export const commentOnPost = async (req, res) => {
  try {
    ...
    // although we created a new resource,
